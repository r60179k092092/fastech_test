Public Class Frm0802
    ...
    Private Sub Frm0802_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If My.Settings.strRange1 = "" Then
            PaperHeader.Text = "模數,5,10,16,20,21"
            HPaperHeader.Text = "30,60,90"
        Else
    ...
    Private Sub showData(strV As String)
        If PaperHeader.Text = "" Then
            MsgBox(BIG2GB("空白紙未定標題分類"))
            Return
        ElseIf HPaperHeader.Text = "" Then
            MsgBox(BIG2GB("高溫紙未定標題分類"))
            Return
        End If
        ...
        PaperHeader.Text = js.ItemNull("EFRATEHeader")
        DG2.DataSource = dt1
        ...
        If dt.Rows.Count = 0 Then
            ...
            Return
        End If
        HPaperHeader.Text = js1.ItemNull("HeatHeader")
        DG3.DataSource = dt2
        initDG(DG3, js1, "EFRATEHROW")

        'DG2.DataSource = strB(dt, dt1)
        'DG2(0, 0).ReadOnly = True
    ...
    Private Sub s1_Frm_UpdateM(s As clsEDITx2013, ByRef strSQL As String) Handles s1.Frm_UpdateM, s1.Frm_InsertM
        ...
        Dim js As New JSON("")
        Dim strV As String = ""
        js.Add("EFRATEHeader", PaperHeader.Text.Trim)
        ...
        js = New JSON("")
        strV = ""
        js.Add("HeatHeader", HPaperHeader.Text.Trim)
        strV = ""
